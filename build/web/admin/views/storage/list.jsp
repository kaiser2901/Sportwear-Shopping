                                    ...
                                    <c:forEach var="prod" items="${list}">
                                        <c:if test="${prod.productId.status == 'True'}">
                                            <tr class="item-${prod.productId} contentPage">
                                                <td><c:out value="${prod.productId.productId}" /></td>
                                                <td class="text-left">
                                                    <c:set var="url" value="${fn:split(prod.productId.imageUrl, ';')}"/>
                                                    <a href="${context}/Products/Detail?id=${prod.productId.productId}" class="view">
                                                        <img src="${context}/assets/images/products/${url[0]}" class="img-fluid"  width="80" height="80"/>
                                                    </a>                      
                                                </td>
