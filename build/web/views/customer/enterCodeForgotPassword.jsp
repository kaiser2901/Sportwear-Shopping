        ...
        <div class="bread-crumb">
            <div class="container">
                ...
                <div class="item active">
                    <a href="${context}/Customer/ForgotPassword">LogIn</a>
                </div>
            </div>
            <!-- End div.container -->
        </div>
        ...
        <div class="login-page">
            <div class="container">
                <div class="form-login">
                    ...
                    <form action="${context}/Customer/Cofirmcode" method="post">
                        <div class="form-group">
                            <label for="">Confirm code<span>*</span></label>
                            <input type="text" name="confirmCode" class="form-control" placeholder="Enter your confirm code">
                            <input hidden value="${confirm}" type="text" name="confirmCodeFromMail">     
                            <input hidden value="${yourmail}" type="text" name="yourmail">
                            
                        </div>

                        <div class="form-group">
                            <button type="submit" class="btn-login submit">Confirm</button>
                        </div>
                        <div class="form-group">
