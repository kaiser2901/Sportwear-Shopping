            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                ...
                <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                    <ul class="u-list-inline g-color-gray-dark-v6">
                        ...
                        <li class="list-inline-item g-mr-10">
                            <a class="u-link-v5 g-color-gray-dark-v6 g-color-secondary--hover g-valign-middle" href="${context}/Admin/Brands/List">List Brands</a>
                        </li>
                    </ul>
                </div>
                <!-- End Breadcrumb-v1 -->
                ...
                <div class="g-pa-20">
                    ...
                    <div class="noty noty_bar noty_type__success noty_theme__unify--v1 g-mb-25">
                        <div class="noty_body">
                            ...
                            <div>Delete brand successfully</div>
                        </div>
                    </div>
                                                ...
                                                <div class="g-pos-rel g-top-3 d-inline-block">
                                                    ...
                                                    <div id="dropDown-${item.brandId}" class="u-shadow-v31 g-pos-abs g-right-0 g-z-index-2 g-bg-white u-dropdown--css-animation u-dropdown--hidden u-dropdown--reverse-y" aria-labelledby="dropDown1Invoker">
                                                        <ul class="list-unstyled g-nowrap mb-0">
                                                            ...
                                                            <li>
                                                                <a data-id="${item.brandId}" data-toggle="modal" data-target="#modal-delete" class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="#">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to delete it? You will lose data about it.
            </div>

            <!-- Modal footer -->
            <div class="modal-footer">
                <a class="btn-delete btn btn-danger" data-dismiss="modal">Delete</a>
...
<script>
    $('a[data-target]').on("click", function(){
        ...
        $('a.btn-delete').attr("href", "${context}/Admin/Categories/Delete?id="+dataId);
    });
        ...
        $(".btn-delete").on("click", function(){
            ...
            $.ajax({
                ...
                success : function(data) {
                    var data = data.split(",");
                    if(data[1].trim() == "true"){
                        $(".noty_type__error").slideDown();
                        $(".noty_type__error .error").text(data[0]);
                        setInterval(function(){
                            $(".noty_type__error").slideUp();
                        }, 7000);
                    }
                    else {
                        $(".item-"+dataId).hide();
                        $(".noty_type__success").slideDown();
                        setInterval(function(){
                            $(".noty").slideUp();
                        }, 7000);
                    }
