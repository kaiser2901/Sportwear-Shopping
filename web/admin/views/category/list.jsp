            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                ...
                <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                    <ul class="u-list-inline g-color-gray-dark-v6">
                        ...
                        <li class="list-inline-item g-mr-10">
                            <a class="u-link-v5 g-color-gray-dark-v6 g-color-secondary--hover g-valign-middle" href="${context}/Admin/Categories/List">List Categories</a>
                        </li>
                    </ul>
                </div>
                <!-- End Breadcrumb-v1 -->
                                                ...
                                                <div class="g-pos-rel g-top-3 d-inline-block">
                                                    ...
                                                    <div id="dropDown-${cat.categoryId}" class="u-shadow-v31 g-pos-abs g-right-0 g-z-index-2 g-bg-white u-dropdown--css-animation u-dropdown--hidden u-dropdown--reverse-y" aria-labelledby="dropDown1Invoker">
                                                        <ul class="list-unstyled g-nowrap mb-0">
                                                            ...
                                                            <li>
                                                                <a data-id="${cat.categoryId}" data-toggle="modal" data-target="#modal-delete" class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="#">
