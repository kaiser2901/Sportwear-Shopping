    ...
    <main class="container-fluid px-0 g-pt-65">
        <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                ...
                <div class="g-pa-20">
                    <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Create Product</h1>
                    <form action="${context}/Admin/Products/Store" enctype="multipart/form-data" method="post">
                        <div class="row">
                            <!-- 1-st column -->
                            <div class="col-md-9">
                                <!-- Basic Text Inputs -->
                                ...
                                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                    ...
                                    <div class="form-group g-mb-30">
                                        ...
                                        <div class="g-pos-rel">
                                            ...
                                            <input required name="productName" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Enter product name">
                                        </div>
                                    </div>
                                    <!-- End Default Input -->
                                    <!-- Default Input -->
                                    <div class="form-group g-mb-30">
                                        ...
                                        <div class="g-pos-rel">
                                            ...
                                            <input required pattern="[0-9]+([\.,][0-9]+)?" step="0.01"
                                                   title="Invalid price" name="price" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Enter price">
                                        </div>
                                    </div>
                                    <!-- End Default Input -->
                                    ...
                                    <div class="form-group g-mb-30">
                                        ...
                                        <textarea class="js-text-editor" data-height="156" name="imageDes" data-placeholder="start typing here"></textarea>                                            
                                    </div>
                                </div>
                                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                    <!-- Advanced File Input -->
                                    <div class="form-group mb-0">
                                        ...
                                        <input  class="js-file-attachment" name="imageProduct" type="file">
                                    </div>
                                        ...
                                        <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-4 mb-0">
                                            <select  name="catId" class="js-select u-select--v3-select u-sibling w-100" title="Select Category" style="display: none;" data-live-search="true">
                                                <c:forEach var="item" items="${listCat}">
                                                    <option value="${item.categoryId}" data-content='<span class="d-flex align-items-center w-100"><span>${item.name}</span></span>'>
                                        ...
                                        <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-4 mb-0">
                                            <select name="brandId" class="js-select u-select--v3-select u-sibling w-100" title="Select Brand" style="display: none;" data-live-search="true">
                                                <c:forEach var="item" items="${listBrand}">
                                                    <option value="${item.brandId}" data-content='<span class="d-flex align-items-center w-100"><span>${item.name}</span></span>'>
                                                        <c:out value="${item.name}" />
                                                    </option>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <div class="g-mb-10">
                                        ...
                                        <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-4 mb-0">
                                            <select name="gender" class="js-select u-select--v3-select u-sibling w-100" title="Select Gender" style="display: none;" data-live-search="true">
                                                <option value="1" data-content='<span class="d-flex align-items-center w-100"><span>Men</span></span>'>
                                                    Men
                                                </option>
                                                <option value="2" data-content='<span class="d-flex align-items-center w-100"><span>Women</span></span>'>
                                                    Women
                                                </option>
                                                <option value="3" data-content='<span class="d-flex align-items-center w-100"><span>Women</span></span>'>
                                                    Unisex
                                                </option>
                                            </select>
                                            <div class="d-flex align-items-center g-absolute-centered--y g-right-0 g-color-gray-light-v6 g-color-lightblue-v9--sibling-opened g-mr-15">
